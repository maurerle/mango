...
if EXEC_RUNTIME_STUDY:
    for func in [distribute_ping_pong_test, distribute_ping_pong_test_timestamp]:
        for max_count in [1, 2, 25, 50, 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 5000, 10000]:
            for connection_type in ["tcp", "mqtt"]:
                ...
                results.append([rename[func.__name__], connection_type, max_count, duration])
else:
...
if SAVE_FIG:
    ...
    pivot_df["roundtrip_per_second"][pivot_df.index <= 1000].plot(figsize=(10,5), grid=True)
